			...
			if(theResults != null)
			{
				...
				for (var x = 0; x < theResults.length; x++) 
				{
					...
					if (videoid%2==0)
					{
						...
						theHTML += '<div class="btn_play" id="playVideo'+videoid+'" ><a href="javascript:void(0)"><img src="img/btn_play_big.png" onClick="playVideo('+videoid+');" ></a></div>';
						theHTML += '<div class="videoInfo_r" id="videoInfo'+videoid+'" >';
						theHTML += '<div class="info_r">';
						theHTML += '<a href="javascript:void(0)" onClick="openTW('+"'"+theResults[x].contactTWurl+"'"+');" class="hoverTW" >'+theResults[x].contactTW+'</a>';
						theHTML += theResults[x].contactName+'<br>';
						theHTML += theResults[x].contactArea+'<br>';
						theHTML += theResults[x].contactCountry+'<br>';
...
function loadVideoEvents()
{
	...
	$('#video11').bind('ended', function () { 
		closeVideoLink(11);	
	});
	
	$('#video12').bind('ended', function () { 
		closeVideoLink(12);	
	});
	
	$('#video13').bind('ended', function () { 
		closeVideoLink(13);	
	});
	
	$('#video14').bind('ended', function () { 
		closeVideoLink(14);	
	});
	...
	$(document).on("mouseover", "#div_video1", function(e) {
		videoHoverIn('1');
	});
	$(document).on("mouseleave", "#div_video1", function(e) {
		videoHoverOut('1');
	});
	
	$(document).on("mouseover", "#div_video2", function(e) {
		videoHoverIn('2');
	});
	$(document).on("mouseleave", "#div_video2", function(e) {
		videoHoverOut('2');
	});
	
	$(document).on("mouseover", "#div_video3", function(e) {
		videoHoverIn('3');
	});
	$(document).on("mouseleave", "#div_video3", function(e) {
		videoHoverOut('3');
	});
	
	$(document).on("mouseover", "#div_video4", function(e) {
		videoHoverIn('4');
	});
	$(document).on("mouseleave", "#div_video4", function(e) {
		videoHoverOut('4');
	});
	
	$(document).on("mouseover", "#div_video5", function(e) {
		videoHoverIn('5');
	});
	$(document).on("mouseleave", "#div_video5", function(e) {
		videoHoverOut('5');
	});
	
	$(document).on("mouseover", "#div_video6", function(e) {
		videoHoverIn('6');
	});
	$(document).on("mouseleave", "#div_video6", function(e) {
		videoHoverOut('6');
	});
	
	$(document).on("mouseover", "#div_video7", function(e) {
		videoHoverIn('7');
	});
	$(document).on("mouseleave", "#div_video7", function(e) {
		videoHoverOut('7');
	});
	
	$(document).on("mouseover", "#div_video8", function(e) {
		videoHoverIn('8');
	});
	$(document).on("mouseleave", "#div_video8", function(e) {
		videoHoverOut('8');
	});
	
	$(document).on("mouseover", "#div_video9", function(e) {
		videoHoverIn('9');
	});
	$(document).on("mouseleave", "#div_video9", function(e) {
		videoHoverOut('9');
	});
	
	$(document).on("mouseover", "#div_video10", function(e) {
		videoHoverIn('10');
	});
	$(document).on("mouseleave", "#div_video10", function(e) {
		videoHoverOut('10');
	});
	
	$(document).on("mouseover", "#div_video11", function(e) {
		videoHoverIn('11');
	});
	$(document).on("mouseleave", "#div_video11", function(e) {
		videoHoverOut('11');
	});
	
	$(document).on("mouseover", "#div_video12", function(e) {
		videoHoverIn('12');
	});
	$(document).on("mouseleave", "#div_video12", function(e) {
		videoHoverOut('12');
	});

	$(document).on("mouseover", "#div_video13", function(e) {
		videoHoverIn('13');
	});
	$(document).on("mouseleave", "#div_video13", function(e) {
		videoHoverOut('13');
	});
	
	$(document).on("mouseover", "#div_video14", function(e) {
		videoHoverIn('14');
	});
	$(document).on("mouseleave", "#div_video14", function(e) {
		videoHoverOut('14');
	});
...
function closeVideo(video)
{
	...
	else
	{
		...
		//HIDE LINK VIDEO
		$('#endVideoHover'+video).css("display","none");
		$('#endVideoLink'+video).css("display","none");
		//SHOW FOX
...
function show_fox()
{
	...
	TweenLite.to(fox_ear_r, 2, {css:{left:"600px"}, ease:Bounce.easeOut});
	...
	TweenLite.to(fox_body1, 2, {css:{left:"418px"}, ease:Bounce.easeOut});
...
function hide_fox()
{
	TweenLite.to(fox_ear_r, 2, {css:{left:"1193px"}, ease:Bounce.easeOut});
	TweenLite.to(fox_ear_r, 1, {rotationY:"-=360eg"});			
