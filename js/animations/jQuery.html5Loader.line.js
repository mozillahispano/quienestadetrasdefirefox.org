...
;(function ($) {
    ...
    $.fn.extend({
		...
		var defaults = {
				lineWidth:          3,                          /* set preloader's line width */
				color:              "#FFFFFF",                  /* set preloader color */
				glowColor:          null,                       /* set shadow color */
				radius:             50,                         /* set the preloader radius (JUST FOR CIRCULAR PRELOADER) */
				font:               "normal 70px Open Sans",  /* set preloader font (you can embed a font by css and use it here) */
