...
;(function ($) {
	...
	$.fn.extend({
		...
		var defaults = {
				...
				color:              "#fb6e0f",                  /* set preloader color */
				glowColor:          "",                  /* set shadow color */
				radius:             70,                         /* set the preloader radius (JUST FOR CIRCULAR PRELOADER) */
				font:               "normal 30px Open Sans",        // set preloader font (you can embed a font by css and use it here) 
