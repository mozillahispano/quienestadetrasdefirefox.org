...
$(document).ready(function() {
	...
	*/
	...
	//CONTACT HOVER
	/*
	$('.contactTW').hover(function(){
		$(".hoverTW").css("display","block");
	},function(){
		$(".hoverTW").css("display","none");
	});
	
	$('.contactGM').hover(function(){
		$(".hoverGM").css("display","block");
	},function(){
		$(".hoverGM").css("display","none");
	});
	*/
	...
	//VIDEO EVENTS
	$('#videoFirefox').bind('ended', function () { //should trigger once on any pause and ended event
		$("#fox_face").css("display","block");
		$("#download").css("display","block");
		//HIDE VIDEO
		...
		//TRACK ANALYTICS EVENT
		_gaq.push(['_trackEvent', 'VIDEO FIREFOX', 'End', 'End Video Firefox']);
